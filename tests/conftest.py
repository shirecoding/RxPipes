...
def pytest_runtest_makereport(item, call):
  ...
  report.procedure = marker.kwargs['procedure'] if marker and 'procedure' in marker.kwargs else "" 
  report.expected = marker.kwargs['expected'] if marker and 'expected' in marker.kwargs else "" 
  report.specification = marker.kwargs['specification'] if marker and 'specification' in marker.kwargs else "" 
